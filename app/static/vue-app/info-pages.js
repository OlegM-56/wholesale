...
<div>
  ...
  <p>
    ...
    Головне меню містить розділ <b>ІНФОРМАЦІЯ</b>, у якому  є опис самої задачі, опис реалізації задачі та відео-презентація проекту.<br>
    Інші розділи меню стосуються безпосередньо роботи додатка.
  </p>
  <hr>
  <p class="italic">
...
<div>
  ...
  <h5>Вимоги до виконання задачі</h5>
  <p>
...
<div>
  ...
  <p>
    ...
    <br><br>
    Моделі SQLAlchemy - це об'єкти, пов'язані з таблицями бази даних, які також містять додаткові методи обробки.<br>
    <i>Наприклад:</i><br>
    ...
    <br><br>
    Моделі в файлах - це об'єкти Python, пов'язані зі структурованими даними, які зберігаються в текстових файлах у форматі JSON.<br>
    ...
    <i>Так реалізовано 'Головне меню' та довідник 'Статус накладної'.</i>
    <br><br>
    Моделі Звітів - це об'єкти Python, які мають методи для формування звітів по інформації, що зберігається в БД.<br>
  </p>
  <h5>Маршрути FLASK</h5>
  <p>
    Для головної сторінки використовуємо функцію, яка передає клієнту із каталогу 'static' файл index.html
    та всі необхідні файли Frontend-фреймворку VUE.js.<br>
    Далі керування відображенням сторінок додатку здійснює Frontend.
    <br><br>
    Роути Backend реалізують надання даних по запитам Frontend.<br>
    ...
    В запити передається назва моделі та пераметри, необхідні для обробки -  '/model/options'.<br>
    Є словник 'Models', який містить всю необхідну інформацію для автоматичної обробки запитів CRUD для всіх моделей.
    <br><br>
    Для виконання додаткових операцій для моделі використовуємо окремий роут з http-методом PATCH.<br>
    Так реалізовано запит на операцію 'Проведення накладних'.
    <br><br>
    Для отримання звітів створено універсальний роут '/report/rep_model/options' з http-методом GET.<br>
    В запит передається назва моделі Звіту та необхідні пераметри.<br>
    Для кожного звіту створено об'єкт (модель), що містить процедури формування звіту.<br>
    Моделі для звітів також містяться в словнику 'Models', що дозволяє автоматично обробляти їх в універсальному роуті.
    <br><br>
  ...
  <h3>Frontend</h3>
  <p>
    Реалізовано на <b>VUE.js</b> ( v2.6.10 ), який є фреймворком, що працює на JavaScript та створений для розробки користувацьких інтерфейсів.<br>
