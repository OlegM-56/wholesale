...
<div>
  ...
  <h3>Backend</h3>
  <p>
    Реалізовано на <b>FLASK</b>, який є фреймворком з відкритим кодом.<br>
    Для роботи з БД використовував ORM (Object Relational Mapping) <b>SQLAlchemy</b>, яка зв'язує об'єкти FLASK з обєктами бази даних,
    створюючи «віртуальну об'єктну базу даних». В результаті в своїй програмі ми оперуємо тільки об'єктами FLASK, напряму не звертаємося до БД.
  ...
  <p>
    ...
    <br><br>
    Моделі в файлах - це об'єкти Pythn, пов'язані з структурованими даними, які зберігаються в текстових файлах у форматі JSON.<br>
  ...
  <p>
    Для головної сторінки використовуємо функцію, яка передає клієнту із каталогу 'static' файл index.html з необхідними файлами Frontend.
    <br><br>
    ...
    <br><br>
    Для отримання звітів створено універсальний роут '/report/rep_model/options' з методом GET.<br>
    ...
    <br><br>
    Обмін інформацією з Frontend здійснюється в форматі JSON.<br>
    Для цього використовується 'flask_marshmallow'. Всі моделі Даних та Звітів мають схеми, які визначають правила серилізації та десеріалізації даних.<br>
  </p>

  <h3>Frontend</h3>
  <p>
    Реалізовано на <b>Vue.js</b> ( v2.6.10 ), який є фреймворком, який працює на JavaScript, створений для розробки користувацьких інтерфейсівз.<br>
    ...
    <ul>
      <li><b>app.js</b> - головний файл нашого проекту, визначення роутів, та глобальних даних
      <li><b>app-components.js</b> - основні компоненти проекту, містять візуалізацію інтерфейсу.
      <li><b>app-mixins.js</b> -  компоненти, які містять основні програмні методи та функції та використовуються в основних компонентах
  ...
  <p>
    ...
    Створені окремі роути для всіх стстичних сторінок та універсальні роути.<br>
    Всі інші функції запускаються за допомогою універсальних роутів.<br>
    В структурі 'appDataset' описані параметри всіх екземплярів об'єктів даних (instance), з якими працює додаток.<br>
    ...
    Для редагування накладних реалізовано окремий компонент, який дозволяє редагувати Заголовок накладної та Рядки накадної та виконувати додаткові операції (проведення, перегляд складського ордеру).<br>
