...
<div>
  ...
  <p>
    ...
    <br><br>
    Моделі - це об'єкти SQLAlchemy, пов'язані з таблицями бази даних, які також містять додаткові методи обробки.<br>
    <i>Наприклад:</i><br>
  ...
  <p>
    ...
    <br><br>
    Для виконання додаткових операцій для моделі використовуємо запит з http-методом PATCH.<br>
